...
const AddTask = ({closeModal, projectId, dates, taskAdditionSuccess}: ProjectModalProps) => {
    ...
    const addEquipment = async() => {
        ...
        // console.log('wer', availableItem)
        
        // await checkEquipmentCount({ availableItem }, `check_equipment_count`)
                ...
                <div>
                    ...
                    <div className="flex gap-2">
                        <select
                            ...
                            disabled={!taskData.startingDate || !taskData.endingDate} // Disable if dates are not set
                        >
